...
import { Button, Field, ProgressRail, TextInput } from '../components/ui'
...
export function AiPlanPage({
  ...
  return (
    <div className="mx-auto max-w-6xl min-w-0 space-y-6">
      <section className="w-full max-w-full min-w-0 overflow-hidden rounded-2xl border border-slate-900 bg-[radial-gradient(circle_at_14%_12%,rgba(34,211,238,0.22),transparent_27%),linear-gradient(135deg,#020617,#071426_52%,#1e1b4b)] shadow-[0_24px_70px_rgba(15,23,42,0.18)]">
        <div className="grid gap-6 p-5 text-white xl:grid-cols-[1.1fr_1fr] xl:items-end">
          <div className="command-centre-mobile-column min-w-0 sm:max-w-none">
            ...
            <p className="mt-3 max-w-full break-words text-sm leading-6 text-slate-300 sm:max-w-2xl">
              Questions, saved chats, and confirmable actions in one calm workspace. Nothing changes until you approve it.
            </p>
          </div>
  ...
  return (
    <div className="grid grid-cols-[72px_1fr_32px] items-center gap-3">
      ...
      <ProgressRail
        ...
        color="#67e8f9"
        trackClassName="h-2 bg-white/10 shadow-slate-950/20"
      />
